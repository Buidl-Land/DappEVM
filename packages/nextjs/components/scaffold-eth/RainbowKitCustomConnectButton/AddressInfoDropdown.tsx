  ...
  return (
    <>
      <details ref={dropdownRef} className="dropdown dropdown-end leading-3">
        <summary tabIndex={0} className="btn bg-primary/40 hover:bg-primary/60 text-white border-transparent backdrop-blur-md btn-sm pl-0 pr-2 shadow-md hover:shadow-lg dropdown-toggle gap-0 !h-auto transition-all duration-200">
